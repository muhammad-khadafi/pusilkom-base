...
public class MenuService {
    ...
    public List<MenuDTO> getMenu2Level() {
        ...
        for (Menu parentMenu :
            ...
            menuExample.createCriteria().andIdParentEqualTo(parentMenu.getId().longValue());
            menuExample.setOrderByClause("menu_order");
            ...
            for (Menu menu :
                ...
                menuExample2.createCriteria().andIdEqualTo(menu.getIdParent().intValue());
    ...
    public String deleteMenu(Long id, String username) {
        ...
        roleHasMenuExample.createCriteria().andIdMenuEqualTo(id.intValue());
