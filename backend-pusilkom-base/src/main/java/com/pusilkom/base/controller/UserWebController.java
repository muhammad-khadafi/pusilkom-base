...
public class UserWebController {
    ...
    public ResponseEntity getUserwebAllByOrganizationAndRoleCode(@PathVariable Integer organizationId, @PathVariable String roleCode) throws Exception {
        ResponseEntity responseEntity = null;
    ...
    @RequestMapping(value = "/user-login-list", method = RequestMethod.GET)
    public ResponseEntity userLoginList() {
        ResponseEntity responseEntity = null;
        try {
            List<UserwebDTO> userwebDTOList = userWebService.getUserLoginList();
            responseEntity = ResponseEntity.ok().body(userwebDTOList);
        } catch (Exception e) {
            log.error("An exception occurred!", e);
            responseEntity = ResponseEntity.badRequest().body(HttpStatus.INTERNAL_SERVER_ERROR);
        }
    ...
    @RequestMapping(value = "/userweb-login-info", method = RequestMethod.PUT)
    public ResponseEntity userwebLoginInfo(@RequestBody UserwebDTO userwebDTO) {
        ResponseEntity responseEntity = null;
        userwebDTO.setLastLogin(new Date());
        try {
            userWebService.simpleUpdateUserweb(userwebDTO);
            responseEntity = ResponseEntity.ok().body(userwebDTO);
        } catch (Exception e) {
            log.error("An exception occurred!", e);
            responseEntity = ResponseEntity.badRequest().body(HttpStatus.INTERNAL_SERVER_ERROR);
    ...
    @RequestMapping(value = "/userweb-logout-info", method = RequestMethod.PUT)
    public ResponseEntity userwebLogoutInfo(@RequestBody UserwebDTO userwebDTO) {
        ResponseEntity responseEntity = null;
        userwebDTO.setLastLogout(new Date());
        try {
            userWebService.simpleUpdateUserweb(userwebDTO);
            responseEntity = ResponseEntity.ok().body(userwebDTO);
        } catch (Exception e) {
    ...
    @RequestMapping(value = "/profil-pengguna/{idUser}", method = RequestMethod.GET)
    public ResponseEntity getProfilPengguna(@PathVariable("idUser") Integer idUser) {
        ResponseEntity responseEntity = null;
        try {
            UserwebDTO userwebDTO = userWebService.getProfilPengguna(idUser);
            responseEntity = ResponseEntity.ok(userwebDTO);
        } catch (Exception e) {
            log.error("An exception occurred!", e);
            responseEntity = ResponseEntity.badRequest().body(HttpStatus.INTERNAL_SERVER_ERROR);
        }
